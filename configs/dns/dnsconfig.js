...
D('nata.cafe', REG_NONE, DnsProvider(CLOUDFLARE),
  ...
  SRV('_pop3s._tcp', 0, 1, 995, 'pop.migadu.com.'),
  CNAME('autoconfig', 'autoconfig.migadu.com.', CF_PROXY_OFF),
  CNAME('key1._domainkey', 'key1.nata.cafe._domainkey.migadu.com.', CF_PROXY_OFF),
  CNAME('key2._domainkey', 'key2.nata.cafe._domainkey.migadu.com.', CF_PROXY_OFF),
  CNAME('key3._domainkey', 'key3.nata.cafe._domainkey.migadu.com.', CF_PROXY_OFF),
  MX('@', 10, 'aspmx1.migadu.com.'),
  MX('@', 20, 'aspmx2.migadu.com.'),
  TXT('@', 'hosted-email-verify=r8nqtrxw'),
  TXT('@', 'v=spf1 include:spf.migadu.com -all'),
  TXT('_dmarc', 'v=DMARC1; p=quarantine;')
)
